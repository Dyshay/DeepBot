...
namespace DeepBot.Core.Handlers.GamePlatform
{
    ...
    {
        [Receiver("M030")]
        public void StreamingErrorPacketHandle(DeepTalk hub, string package, UserDB user, string tcpId, IMongoCollection<UserDB> manager)
        {
        ...
        [Receiver("M031")]
        public void NetworkErrorPacketHandle(DeepTalk hub, string package, UserDB user, string tcpId, IMongoCollection<UserDB> manager)
        {
        ...
        [Receiver("M032")]
        public void FloodConnexionErrorPacketHandle(DeepTalk hub, string package, UserDB user, string tcpId, IMongoCollection<UserDB> manager)
        {
