...
namespace DeepBot.Core.Handlers.GamePlatform
{
    ...
    {
        [Receiver("M030")]
        public void StreamingErrorPacketHandle(DeepTalk hub, string package, Account account, string tcpId)
        {
        ...
        [Receiver("M031")]
        public void NetworkErrorPacketHandle(DeepTalk hub, string package, Account account, string tcpId)
        {
        ...
        [Receiver("M032")]
        public void FloodConnexionErrorPacketHandle(DeepTalk hub, string package, Account account, string tcpId)
        {
