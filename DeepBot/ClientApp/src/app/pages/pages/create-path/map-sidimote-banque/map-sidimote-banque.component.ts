...
@Component({
    selector: 'app-map-sidimote-banque',
    templateUrl: './map-sidimote-banque.component.html',
    styleUrls: ['./map-sidimote-banque.component.scss']
})
/** map-sidimote-banque component*/
export class MapSidimoteBanqueComponent {
