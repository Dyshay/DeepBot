...
@Component({
    selector: 'app-map-sidimote-retour',
    templateUrl: './map-sidimote-retour.component.html',
    styleUrls: ['./map-sidimote-retour.component.scss']
})
/** map-sidimote-retour component*/
export class MapSidimoteRetourComponent {
