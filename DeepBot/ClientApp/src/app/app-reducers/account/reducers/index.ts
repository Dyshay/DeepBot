...
export const getMap = createSelector(selectAccountStatusState, fromAccount.getMap);
export const getCurrentAccount = createSelector(selectAccountStatusState, fromAccount.getCurrentAccount);
